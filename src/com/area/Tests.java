...
public class Tests {
	...
	public static void testSimplePolygon()
	{
		Polygon polygon ;
				...
				polygonBuilder.addVertex(new Point(1, 3));
				polygonBuilder.addVertex(new Point(2, 8));
				polygonBuilder.addVertex(new Point(5, 4));
				polygonBuilder.addVertex(new Point(5, 9));
				polygonBuilder.addVertex(new Point(7, 5));
				polygonBuilder.addVertex(new Point(6, 1));
				polygonBuilder.addVertex(new Point(3, 1));
	...
	public static void testPolygonWithHoles() {
		Polygon polygon = Polygon.Builder()
				...
				// polygon
				.addVertex(new Point(1, 6)).addVertex(new Point(8, 7))
				.addVertex(new Point(8, 1)).close().addVertex(new Point(2, 3))
				// hole one
				.addVertex(new Point(5, 5)).addVertex(new Point(6, 2)).close()
				.addVertex(new Point(6, 6)) // hole two
				.addVertex(new Point(7, 6)).addVertex(new Point(7, 5)).build();
